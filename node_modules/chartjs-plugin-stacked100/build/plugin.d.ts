...
export declare const summarizeValues: (datasets: ChartData["datasets"], visibles: number[], isHorizontal: boolean, individual: boolean, parsing?: ParsingOptions["parsing"]) => {
    [key: string]: number;
    [key: symbol]: number;
}[];
